    ...
    <div class="card-content">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 form-group">
                    <img src="{{assetUrl($general->favicon())}}" style="max-width: 60px;" />
                    @if($general->favicon)
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 form-group">
                    <img src="{{assetUrl($general->logo())}}" style="max-width: 150px;" />
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 form-group">
                    <img src="{{assetUrl($general->footerLogo())}}" style="max-width: 150px;" />
