...
@endsection 
@push('css')
<link rel="stylesheet" type="text/css" href="{{assetUrl(assetLinkAdmin().'/app-assets/vendors/css/tables/datatable/datatables.min.css')}}" />
<link rel="stylesheet" type="text/css" href="{{assetUrl(assetLinkAdmin().'/app-assets/vendors/css/tables/extensions/buttons.dataTables.min.css')}}" />
<link rel="stylesheet" type="text/css" href="{{assetUrl(assetLinkAdmin().'/app-assets/vendors/css/tables/datatable/buttons.bootstrap4.min.css')}}" />
@endpush 
@section('contents')
...
<script src="{{assetUrl(assetLinkAdmin().'/app-assets/vendors/js/tables/datatable/datatables.min.js')}}"></script>
<script src="{{assetUrl(assetLinkAdmin().'/app-assets/vendors/js/tables/datatable/dataTables.buttons.min.js')}}"></script>
<script src="{{assetUrl(assetLinkAdmin().'/app-assets/vendors/js/tables/datatable/buttons.bootstrap4.min.js')}}"></script>
<script src="{{assetUrl(assetLinkAdmin().'/app-assets/vendors/js/tables/jszip.min.js')}}"></script>
<script src="{{assetUrl(assetLinkAdmin().'/app-assets/vendors/js/tables/pdfmake.min.js')}}"></script>
<script src="{{assetUrl(assetLinkAdmin().'/app-assets/vendors/js/tables/vfs_fonts.js')}}"></script>
<script src="{{assetUrl(assetLinkAdmin().'/app-assets/vendors/js/tables/buttons.html5.min.js')}}"></script>
<script src="{{assetUrl(assetLinkAdmin().'/app-assets/vendors/js/tables/buttons.print.min.js')}}"></script>
<script src="{{assetUrl(assetLinkAdmin().'/app-assets/vendors/js/tables/buttons.colVis.min.js')}}"></script>
