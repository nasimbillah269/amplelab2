    	   	        ...
    	   	        <div class="col-md-8">
    	   	            <table class="table table-borderless mediaDetails">
    	   	                ...
    	   	                <tr>
    	   	                    ...
    	   	                    <td style="padding: 5px;"><input type="text" class="form-control form-control-sm urlcopytext" id="myInput" value="{{assetUrl($media->file_url)}}" /></td>
    	   	                </tr>
    	   	                <tr>
