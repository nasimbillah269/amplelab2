                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <img src="{{assetUrl($page->image())}}" style="max-width: 100px;" />
                                    @isset(json_decode(Auth::user()->permission->permission, true)['pages']['add'])
                                    @if($page->imageFile)
                                ...
                                <div class="form-group">
                                    <img src="{{assetUrl($page->banner())}}" style="max-width: 200px;" />
                                    @isset(json_decode(Auth::user()->permission->permission, true)['pages']['add'])
                                    @if($page->bannerFile)
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="template">
                                        ...
                                        <option value="Categories" {{$page->template=='Categories'?'selected':''}}>Categories</option>
                                        <option value="Tender Support" {{$page->template=='Tender Support'?'selected':''}}>Tender Support</option>
                                        <option value="Service & Support" {{$page->template=='Service & Support'?'selected':''}}>Service & Support</option>
                                        <option value="Catelog" {{$page->template=='Catelog'?'selected':''}}>Catelog</option>
