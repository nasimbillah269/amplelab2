                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="data_type" required="">
                                 ...
                                 <option value="Flash Sale" {{$homedata->data_type=='Flash Sale'?'selected':''}}>Flash Sale</option>
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <img src="{{assetUrl($homedata->image())}}" style="max-width: 100px;" />
                        ...
                        <div class="form-group">
                            <img src="{{assetUrl($homedata->banner())}}" style="max-width: 100px;" />
                        ...
                        <div class="form-group">
                            <img src="{{assetUrl($homedata->banner2())}}" style="max-width: 100px;" />
                            @if($homedata->bannerFile)
                            <a href="{{route('admin.mediesDelete',$homedata->bannerFile->id)}}" class="mediaDelete" style="color: red;"><i class="fa fa-trash"></i></a>
                            @endif
                        </div>
