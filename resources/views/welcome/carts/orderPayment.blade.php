...
<meta property="og:image" content="{{assetUrl(App\Models\General::first()->logo?:'public/admin-assets/img/logo.png')}}" />
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane container {{$active=='online_payment'?'bg-white active':'fade'}}" id="online">
                                <div class="p-5">
                                    <img src="{{assetUrl('public/medies/SS-Commerz-Pay-With-logo.png')}}" width="100%" /> <br />
                                    <br />
