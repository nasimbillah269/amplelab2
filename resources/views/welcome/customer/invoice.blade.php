                                ...
                                <div class="container invoiceContainer">
                                    <div class="invoice-inner">
                                        <div class="invoice-header">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img style="max-width: 110px" src="{{assetUrl(general()->logo())}}" />
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-7">
                                                    ...
                                                    <div class="paidsStatus" style="text-align: center;">
                                                        <img src="{{assetUrl('public/medies/paid.png')}}" style="max-width: 120px;" />
                                                    </div>
                                                    @endif
                                                </div>
                                            </div>
...
<script src="{{assetUrl('public/batikrom/js/inword.js')}}"></script>
...
<script src="{{assetUrl('public/app-assets/js/printThis.js')}}"></script>
